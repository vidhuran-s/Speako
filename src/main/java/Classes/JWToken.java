...
public class JWToken {
    ...
    // Secret Key for Signing JWT it will keep it secure and long enough
    ...
    public String generateToken(long userId) {
        return Jwts.builder()
                .subject(String.valueOf(userId)) // Storing user ID in token
                .issuedAt(new Date())
